...
public class QuanLyKhachHang extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addComponent(btnChonAnh, javax.swing.GroupLayout.PREFERRED_SIZE, 27,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(btnThem, javax.swing.GroupLayout.PREFERRED_SIZE, 118,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnCapNhat, javax.swing.GroupLayout.PREFERRED_SIZE, 118,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnXoa, javax.swing.GroupLayout.PREFERRED_SIZE, 118,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(btnThoat, javax.swing.GroupLayout.PREFERRED_SIZE, 118,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout
                                        ...
                                        .addComponent(txtTimKiem)
                                        .addComponent(btnTimKiem, javax.swing.GroupLayout.DEFAULT_SIZE, 35,
                                                Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(btnThem, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnCapNhat, javax.swing.GroupLayout.PREFERRED_SIZE, 35,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tabKhachHangMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tabKhachHangMouseClicked
        ...
        if (selectedRow != -1) { // Kiểm tra xem có dòng nào được chọn không
            ...
            // Lấy dữ liệu từ bảng
            idKhachHang = Integer.parseInt(model.getValueAt(selectedRow, 0).toString());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            String[] options = {"Thêm", "Thoát"};
            int choice = JOptionPane.showOptionDialog(this, "Bạn có muốn thêm khách hàng không?", "Xác nhận",
                    JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

            if (choice != 0) { // Nếu không chọn "Thêm" thì thoát
                return;
            }
            // Gọi hàm trong DAO để thêm khách hàng vào CSDL
            KhachHangDAO khachHangDAO = new KhachHangDAO();
            khachHangDAO.themKhachHang(hoTen, diaChi, soDienThoai, cccd, hinhAnhCCCD);
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Vui lòng chọn khách hàng cần cập nhật!", "Cảnh báo",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            // Lấy mô hình dữ liệu của bảng
            DefaultTableModel model = (DefaultTableModel) tabKhachHang.getModel();
            int idKhachHang = Integer.parseInt(model.getValueAt(selectedRow, 0).toString());
            ...
            // Hộp thoại xác nhận
            String[] options = {"Sửa", "Thoát"};
            int choice = JOptionPane.showOptionDialog(this, "Bạn có muốn sửa thông tin khách hàng không?", "Xác nhận",
                    JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

            if (choice != 0) { // Nếu không chọn "Sửa" thì thoát
                return;
            }
            // Gọi hàm cập nhật khách hàng
            KhachHangDAO khachHangDAO = new KhachHangDAO();
            khachHangDAO.suaKhachHang(idKhachHang, hoTen, diaChi, soDienThoai, cccd, hinhAnhCCCD);
            loadData();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {
        int selectedRow = tabKhachHang.getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn khách hàng cần xóa!", "Cảnh báo",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Hộp thoại xác nhận xóa
        String[] options = {"Xóa", "Thoát"};
        int choice = JOptionPane.showOptionDialog(this, "Bạn có chắc chắn muốn xóa khách hàng này?", "Xác nhận",
                JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);

        if (choice != 0) { // Nếu không chọn "Xóa" thì thoát
            return;
        }
        khachHangDAO.xoaKhachHang(idKhachHang);
        loadData();
